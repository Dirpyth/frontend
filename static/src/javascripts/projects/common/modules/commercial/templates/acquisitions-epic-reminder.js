...
export const acquisitionsEpicReminderTemplate = `
    <div id="epic-reminder" class="js-epic-reminder epic-reminder">
        ...
        <div class="epic-reminder__signup" >
            ...
            <div class="epic-reminder__form-title">Remind me in March</div>
            ...
            <form>
                ...
                <div class="epic-reminder__submit-button-wrapper">
                    <input type="submit" class="epic-reminder__submit-button" value="Set a reminder">
                </div>
            </form>

            <small id="epic-reminder__email-terms-and-conditions" class="epic-reminder__email-help-text">
                We will use this to send you a single email in March. To find out what personal data we collect and how we use it, please visit our <a href="#">Privacy Policy</a>
            </small>
        </div>
    </div>
`;
